...
# translation
SOURCES = clipper.py ui_clipper.py __init__.py #clipperdialog.py
#TRANSLATIONS = i18n/clipper_en.ts
TRANSLATIONS =
...
PY_FILES = clipper.py __init__.py #clipperdialog.py

EXTRAS = icon.png metadata.txt

UI_FILES = #ui_clipper.py
